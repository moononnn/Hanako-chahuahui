...
/**
 * @param {{partnerName: string, partnerId: string, personaText: string, userName: string, note?: string, memoryText?: string, knowingText?: string, stickerText?: string, wakeText?: string, passText?: string, replyText?: string, timeText?: string, daybookText?: string, workfeedText?: string}} input
 */
export function buildSystemPrompt(input) {
  const { partnerName, personaText, userName, note, memoryText, knowingText, stickerText, wakeText, passText, replyText, timeText, daybookText, workfeedText } = input;
