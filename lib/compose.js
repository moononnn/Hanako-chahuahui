 ...
 */
export function proactiveSpec({ partnerName, userName, topic, hobby, memoryText, relationNote, searchContext, stickerText, currentTimeText, followup, wakeEcho, sceneEcho, contextText }) {
